...
?>
	...
	<?php
					echo "Le programme détaillé par jour est disponible sur cette page. Vous avez également accès aux résumés courts et longs (à partir de la date limite de soumission des versions révisées). Retour sur le <a href='".$website_url."'>site principal de la manifestation</a>.";
	?>
				</div> <!-- media-body -->
			</div> <!-- media -->
		</div> <!-- well -->
