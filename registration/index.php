...
if ($submitted and !$verified) {
  ...
  if($reason==="empty") {
    echo "<div class='alert alert-danger' role='alert'>Veuillez compléter tous les champs manquants en rouge.</div>";
  } elseif($reason==="email") {
...
if (!$confirmed) {
  ...
  if (!$submitted) {
    echo "<div class='alert alert-info' role='alert'>Votre inscription peut &ecirc;tre mise à jour à tout moment en remplissant de nouveau ce formulaire <strong>avec la m&ecirc;me adresse e-mail</strong>. Le tarif de la date de votre première inscription vous sera automatiquement appliqué lors de toute modification. ".$welcome_message."</div>";
  }
  if ($verified) {
